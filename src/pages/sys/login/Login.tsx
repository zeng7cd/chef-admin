...
const { VITE_APP_HOMEPAGE: HOMEPAGE,VITE_APP_SYSTEM_NAME:SYSTEM_NAME } = import.meta.env;
...
function Login() {
  ...
  return (
    <Layout className="relative flex !min-h-screen !w-full !flex-row">
      ...
      >
        <div className="text-3xl font-bold leading-normal lg:text-4xl xl:text-5xl">{SYSTEM_NAME}</div>
